...
-- Records of t_cinema
-- ----------------------------
INSERT INTO `t_cinema` VALUES (1, '横店电影城(庆丰店)', '13498476303', '广东', '广州', '白云区', '白云区庆丰广场路财智广场2楼');
...
CREATE TABLE `t_comment`  (
  ...
  `comment_date` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '评论日期',
...
-- ----------------------------
INSERT INTO `t_comment` VALUES (31, 44, 1, 9, '好看，推荐！', '2019-5-6', 0, 1, NULL);
INSERT INTO `t_comment` VALUES (32, 1, 33, 7, '1234566', '2019-5-9', 1, 1, '[1]');
INSERT INTO `t_comment` VALUES (33, 50, 13, 9, 'test', '2019-5-10', 1, 1, '[29]');
INSERT INTO `t_comment` VALUES (34, 50, 19, 8, '还不错！！！！！', '2019-5-10', 1, 1, '[23]');
INSERT INTO `t_comment` VALUES (35, 50, 12, 8, '值得一看！', '2019-5-10', 0, 1, NULL);
INSERT INTO `t_comment` VALUES (37, 25, 34, 7, '还不错！', '2019-5-10', 0, 1, NULL);
INSERT INTO `t_comment` VALUES (38, 25, 17, 9, '哈哈哈哈哈！', '2019-5-10', 2, 1, '[35,23]');
INSERT INTO `t_comment` VALUES (39, 29, 13, 10, '必须满分！', '2019-5-10', 0, 1, NULL);
INSERT INTO `t_comment` VALUES (40, 29, 20, 9, '电影很好看，演员演技满分！', '2019-5-10', 2, 1, '[35,23]');
INSERT INTO `t_comment` VALUES (41, 35, 20, 10, '超赞！很燃！', '2019-5-10', 0, 1, NULL);
INSERT INTO `t_comment` VALUES (45, 23, 13, 8, '8888888', '2019-5-11', 0, 0, NULL);
INSERT INTO `t_comment` VALUES (46, 1, 35, 8, '无', '2019-5-11', 0, 1, NULL);
...
-- Records of t_movie
-- ----------------------------
INSERT INTO `t_movie` VALUES (1, '驯龙高手3', '/images/movie/hot1.jpg', '迪恩·德布洛斯', '刘昊然', '13分钟', '英语', '统领伯克岛的酋长嗝嗝（刘昊然 配音），与阿丝翠德（亚美莉卡·费雷拉 配音）共同打造了一个奇妙而热闹的飞龙乌托邦。一只雌性光煞飞龙的意外出现，加上一个前所未有的威胁的到来，令嗝嗝和没牙仔不得不离开自己唯一的家园，前往他们本以为只存在于神话之中的隐秘之境。在发现自己真正的命运之后，飞龙与骑士将携手殊死奋战，保护他们所珍爱的一切。', '动漫', '2018-12-12', 0, 9.0);
...
INSERT INTO `t_movie` VALUES (4, '比悲伤更悲伤的故事', '/images/movie/hot4.jpg', '林孝谦', '陈庭妮', '105分钟', '国语', '唱片制作人张哲凯（刘以豪 饰）和王牌作词人宋媛媛（陈意涵 饰）相依为命，两人自幼身世坎坷只有彼此为伴，他们是亲人、是朋友，也彷佛是命中注定的另一半。父亲罹患遗传重症而被母亲抛弃的哲凯，深怕自己随时会发病不久人世，始终没有跨出友谊的界线对媛媛展露爱意。眼见哲凯的病情加重，他暗自决定用剩余的生命完成他们之间的终曲，再为媛媛找个可以托付一生的好男人。这时，事业有成温柔体贴的医生（张书豪 饰）适时的出现让他成为照顾媛媛的最佳人选，二人按部就班发展着关系。一切看似都在哲凯的计划下进行。然而，故事远比这里所写更要悲伤', '言情', '2018-9-1', 0, NULL);
...
INSERT INTO `t_movie` VALUES (7, '我叫为何', '/images/movie/1.jpg', '李小军', '乔新峰', '86分钟', '国语', '讲述了两个技术宅男为何和吕相立志设计一款以圣朝名将无束为主角的火爆游戏。作为战神无束的死忠粉丝，为何在设计游戏的过程中，意外穿越到了圣朝，有机会亲眼目睹无束驱除西土的宏大场面。', '喜剧', '2019-8-20', 0, NULL);
...
INSERT INTO `t_movie` VALUES (10, '境界', '/images/movie/4.jpg', '佐藤信介', '真野惠里菜', '108分钟', '日语', '从小异于常人的黑崎一护（福士苍汰 饰），在一次机缘巧合下遭遇女死神“朽木露琪亚”（杉咲花 饰）。 露琪亚是将灵魂从现实世界引领到尸魂界的收魂者之一，他们为保护人类 不被“虚” 侵害，一直在与这些怪物战斗。在与一只异常强大的“虚” 战斗时，露琪亚身负重伤，无奈只能将死神 的力量暂时转给黑崎一护，让其代为战斗。两人经过一段时间的磨合后并肩战斗，终于战胜了当年害死一护母亲的“虚”，但在这期间，露琪亚的兄长朽木白哉（石原贵雅 饰）强迫她不顾黑崎一护的生命安危收回法力。露琪亚为保护一护，拖延到与“虚”的战斗结束，并清除了一护的记忆', '动作', '2019-11-12', 0, NULL);
...
INSERT INTO `t_movie` VALUES (12, '毕业旅行之逍遥骑士', '/images/movie/6.jpg', '郭奎永', '田雨', '90分钟', '国语', '高考落榜的文艺少年杨风（张朔祯 饰）梦想成为一个“嬉皮士”浪子，并誓要在毕业旅行中完成自己的浪子清单：打架、泡妞、吸烟喝酒、打坐冥想、和摇滚歌手交朋友……他在好友陈火（赵一凡 饰）的相助下伪装成“逍遥骑士”，想借助漂亮师姐思思（安紫依 饰）完成自己的“破处之旅”，却没想到思思也暗藏自己的“少女成人计划”，“逍遥路上”演绎啼笑皆非的动人故事。', '青春', '2019-11-11', 1, 8.0);
INSERT INTO `t_movie` VALUES (13, '复仇者联盟4', '/images/movie/7.jpg', '乔·罗素', '小罗伯特·唐尼', '181分钟', '英语', '改编自漫威漫画，也是漫威电影宇宙第22部影片。复仇者联盟的一众超级英雄，必须抱着牺牲一切的信念，与史上最强大反派灭霸殊死一搏，阻止其摧毁宇宙的邪恶计划。', '动作', '2019-4-24', 3, 9.5);
...
INSERT INTO `t_movie` VALUES (15, '云雾笼罩的山峰', '/images/movie/9.jpg', '左志国', '王海涛', '92分钟', '国语', '一位年轻的父亲为了筹钱医治自己病重的爱女，又要不到拖欠的赔款，被迫铤而走险绑架了老板的女儿。然而他不知道的是，在这座幽静的山里，还有其他人带着不同的目的和欲望参与了这件事情，一座山上、一日之内、六组人马，各自的贪念在错综复杂的因果之下，逐渐失控，转向不可预知的方向。罪恶之中，谁能逃脱命运的审判？', '悬疑', '2019-7-14', 0, NULL);
...
INSERT INTO `t_movie` VALUES (17, '绿皮书', '/images/movie/hot7.jpg', '皮特·法雷里', '维果·莫腾森', '130分钟', '英语', '一名黑人钢琴家，为前往种族歧视严重的南方巡演，找了一个粗暴的白人混混做司机。在一路开车南下的过程里，截然不同的两人矛盾不断，引发了不少争吵和笑料。但又在彼此最需要的时候，一起共渡难关。行程临近结束，两人也慢慢放下了偏见...... 绿皮书，是一本专为黑人而设的旅行指南，标注了各城市中允许黑人进入的旅店、餐馆。电影由真实故事改编。', '剧情', '2019-3-1', 1, 9.0);
...
INSERT INTO `t_movie` VALUES (19, '狗眼看人心', '/images/movie/hot9.jpg', '吴楠', '黄磊', '91分钟', '国语', '本片讲述了一桩因“狗咬狗”引发的连锁故事。余峰（黄磊 饰）、亮亮（闫妮 饰）、余一诺（安吉 饰）家的小狗妮蔻，为了救主人被隔壁藏獒咬成重伤，有权有势的藏獒主人却对余峰一家百般刁难。面对种种不公，余峰不再忍气吞声，发誓要为小狗讨回公道，但柴女士（汤唯 饰）等人的出现，却让矛盾进一步激化......狗生不易，小狗愿意用生命守护我们，我们又能为它做什么呢？', '剧情', '2019-4-20', 0, 8.0);
INSERT INTO `t_movie` VALUES (20, '祈祷落幕时', '/images/movie/hot10.jpg', '福泽克雄', '阿部宽', '119分钟', '日语', '在东京都葛饰区小菅的某座公寓里，发现了一具被勒死的女性遗体。被害者是在清洁公司上班、住在滋贺县的押谷道子（中岛博子 饰）。而杀人现场的住户越川睦夫也下落不明。而以松宫（沟端淳平 饰）等警视厅搜查一科的刑警们查不出越川与押谷道子有何交集，案件调查陷入困境。尽管查明押谷道子是为了拜访她的同学，即导演浅居博美（松岛菜菜子 饰）才来东京的，但博美与越川之间也找不出什么交集。这时，案发地点附近发现了被烧死的尸体，松宫怀疑两者有关联。从遗物中，发现了写有日本桥周围12座桥名的文字。知道此事后加贺恭一郎（阿部宽 饰）非常激动，因为那东西与他的亡母大有关联。', '剧情', '2019-4-12', 2, 9.5);
...
INSERT INTO `t_movie` VALUES (33, '罗马', '/images/movie/1557394982584.jpg', '张三', '李四', '1200分钟', '粤语', '嘻嘻嘻嘻嘻', '言情', '2019-5-23', 1, 7.0);
INSERT INTO `t_movie` VALUES (34, '来电狂响', '/images/movie/1557457509601.jpg', '张三', '董大伟', '130分钟', '国语', '七个好友聚餐，有人提议大家玩一个将手机公开的游戏：与在场所有人分享当晚收到的每一条短信、每一个电话，每一个弹窗，由此掀开了一场轩然大波。 一条短信，拆散一对恩爱夫妻；一个电话，推翻多年发小感情……数字时代，小小手机藏了无数秘密，当手机变成锋利的利刃，当聚餐局变成“揭 秘局”，信任危机过后他们能否跨越信任危机，重新思考彼此之间的亲密关系………..', '悬疑', '2019-5-31', 2, 7.0);
INSERT INTO `t_movie` VALUES (35, '雪暴', '/images/movie/1557555972902.jpg', '张三', '李四', '120分钟', '国语', '无', '喜剧', '2019-5-17', 1, 8.0);
INSERT INTO `t_movie` VALUES (36, '一个母亲的复仇', '/images/movie/1559052907649.jpg', '王明', '张三', '118分钟', '国语', '一个母亲的复仇', '悬疑', '2019-11-14', 0, NULL);
...
INSERT INTO `t_order` VALUES (77, 49, 50, '13414851033', '2019-5-8', 2, 112.00, '[37,36]', '0', '624763');
INSERT INTO `t_order` VALUES (78, 1, 62, '13414850282', '2019-5-9', 3, 201.00, '[25,26,36]', '0', '311661');
...
INSERT INTO `t_order` VALUES (89, 1, 62, '13414850282', '2019-6-21', 4, 268.00, '[18,38,47,44]', '1', '152229');
...
-- ----------------------------
INSERT INTO `t_schedule` VALUES (50, 20, 5, '1号激光厅', '2019-5-22', '20:05', 56.00, '[37,36,35]');
...
INSERT INTO `t_schedule` VALUES (62, 9, 2, '1号激光厅', '2019-8-14', '12:05', 67.00, '[25,26,36,18,38,47,44]');
INSERT INTO `t_schedule` VALUES (63, 4, 2, '1号激光厅', '2019-5-23', '08:05', 46.10, NULL);
INSERT INTO `t_schedule` VALUES (64, 8, 7, '1号激光厅', '2019-9-24', '12:05', 78.00, NULL);
INSERT INTO `t_schedule` VALUES (67, 12, 6, '1号激光厅', '2019-11-18', '16:05', 66.00, NULL);
INSERT INTO `t_schedule` VALUES (68, 15, 1, '1号激光厅', '2019-7-21', '16:05', 34.00, NULL);
...
INSERT INTO `t_schedule` VALUES (79, 1, 7, '1号激光厅', '2019-7-11', '08:05', 45.00, NULL);
INSERT INTO `t_schedule` VALUES (80, 4, 8, '1号激光厅', '2019-8-14', '20:05', 38.00, NULL);
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'LyuJ1ong', '/images/avatar/man.jpg', '123456', '13414850282', '男', '2008-08-18', 'Hello World');
...
INSERT INTO `t_wishmovie` VALUES (80, 1, 13);
